...
echo "liftover_hg19_hg38 = \"https://hgdownload.cse.ucsc.edu/goldenpath/hg19/liftOver/hg19ToHg38.over.chain.gz\"" >> ./bin/settings.ini
echo "liftover_hg38_hg19 = \"https://hgdownload.cse.ucsc.edu/goldenpath/hg38/liftOver/hg38ToHg19.over.chain.gz\"" >> ./bin/settings.ini
