...
private:
	...
	TEST_METHOD(ReportVariantConfiguration_isManuallyCurated)
	{
		ReportVariantConfiguration rvc;
		rvc.variant_type = VariantType::SNVS_INDELS;
		rvc.variant_index = 0;
	...
	TEST_METHOD(ReportVariantConfiguration_manualVarGenoIsValid)
	{
		ReportVariantConfiguration rvc;
		rvc.variant_type = VariantType::SNVS_INDELS;
		rvc.variant_index = 0;
	...
	TEST_METHOD(ReportVariantConfiguration_manualCnvStartIsValid)
	{
		ReportVariantConfiguration rvc;
		rvc.variant_type = VariantType::CNVS;
		rvc.variant_index = 0;
	...
	TEST_METHOD(ReportVariantConfiguration_manualCnvEndIsValid)
	{
		ReportVariantConfiguration rvc;
		rvc.variant_type = VariantType::CNVS;
		rvc.variant_index = 0;
	...
	TEST_METHOD(ReportVariantConfiguration_manualCnvCnIsValid)
	{
		ReportVariantConfiguration rvc;
		rvc.variant_type = VariantType::CNVS;
		rvc.variant_index = 0;
	...
	TEST_METHOD(ReportVariantConfiguration_manualSvStartIsValid)
	{
		ReportVariantConfiguration rvc;
		rvc.variant_type = VariantType::SVS;
		rvc.variant_index = 0;
	...
	TEST_METHOD(ReportVariantConfiguration_manualSvEndIsValid)
	{
		ReportVariantConfiguration rvc;
		rvc.variant_type = VariantType::SVS;
		rvc.variant_index = 0;
	...
	TEST_METHOD(ReportVariantConfiguration_manualSVGenoIsValid)
	{
		ReportVariantConfiguration rvc;
		rvc.variant_type = VariantType::SVS;
		rvc.variant_index = 0;
	...
	TEST_METHOD(ReportVariantConfiguration_manualSvStartBndIsValid)
	{
		ReportVariantConfiguration rvc;
		rvc.variant_type = VariantType::SVS;
		rvc.variant_index = 0;
	...
	TEST_METHOD(ReportVariantConfiguration_manualSvEndBndIsValid)
	{
		ReportVariantConfiguration rvc;
		rvc.variant_type = VariantType::SVS;
		rvc.variant_index = 0;
