...
public:
	...
	virtual void main()
	{
        ...
        out << "LiftOver Statistics:" << Qt::endl;
		out << "Input regions : " << in_count << Qt::endl;
        out << "lifted        : " << lifted_count << " (" << QString::number(100.0*lifted_count/in_count, 'f', 2) << "%)" << Qt::endl;
        out << "unlifted      : " << unlifted_count << " (" << QString::number(100.0*unlifted_count/in_count, 'f', 2) << "%)" << Qt::endl;
        out << Qt::endl;
        out << "Bases input: " << in_length << Qt::endl;
        out << "lifted     : " << lifted_in_length << " (" << QString::number(100.0*lifted_in_length/in_length, 'f', 2) << "%)" << Qt::endl;
        out << "unlifted   : " << unlifted_in_length  << " (" << QString::number(100.0*unlifted_in_length/in_length, 'f', 2) << "%)" << Qt::endl;
        out << Qt::endl;
        out << "Bases after lifting: " << lifted_length << Qt::endl;
