...
private:
	...
	TEST_METHOD(test_convertContentTypeToString)
	{
	...
	TEST_METHOD(test_getContentTypeByFilename)
	{
	...
	TEST_METHOD(test_convertErrorTypeToText)
	{
	...
	TEST_METHOD(test_getErrorCodeByType)
	{
