...
{
    QSet<int> variant_indices = NGSHelper::listToSet(sett.report_config.variantIndices(VariantType::SNVS_INDELS, false));
...
{
    QSet<int> variant_indices = NGSHelper::listToSet(sett.report_config.variantIndicesGermline());
...
CnvList SomaticReportSettings::filterCnvs(const CnvList &cnvs, const SomaticReportSettings &sett)
{
    ...
    QSet<int> cnv_indices = NGSHelper::listToSet(sett.report_config.variantIndices(VariantType::CNVS, false));
...
BedpeFile SomaticReportSettings::filterSvs(NGSD& db, const BedpeFile& svs, const SomaticReportSettings& sett)
{
    ...
    QSet<int> sv_indicies = NGSHelper::listToSet(sett.report_config.variantIndices(VariantType::SVS, true));
