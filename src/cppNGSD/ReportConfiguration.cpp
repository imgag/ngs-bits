...
{
	if (!LoginManager::userCanPerformAction(ActionPermission::CHANGE_NGSD_DATA)) THROW(AccessDeniedException, "You do not have permissions to remove a report configuration!");
