...
{
	if (NGSD().userCanPerformAction(LoginManager::userId(), Permission::READ_ONLY)) THROW(AccessDeniedException, "You do not have permissions to remove a report configuration!");
