...
public:
	...
	GeneSet phenotypeToFilteredGenes(int id, QList<PhenotypeSource> allowedSources, QList<PhenotypeEvidence> allowedEvidences, bool recursive, bool ignore_non_phenotype_terms);
