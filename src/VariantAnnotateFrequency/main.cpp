...
public:
	...
	virtual void main()
	{
		...
		input.annotations().append(VariantAnnotationDescription(prefix + "freq", "Variant frequency.", VariantAnnotationDescription::FLOAT));
		if (depth)
		{
			input.annotations().append(VariantAnnotationDescription(prefix + "depth", "Sequencing depth at the variant position.",VariantAnnotationDescription::INTEGER));
		}
		if (mapq0)
		{
			input.annotations().append(VariantAnnotationDescription(prefix + "mapq0_frac", "Fraction of reads with mapping quality 0 at the variant position.",VariantAnnotationDescription::INTEGER));
		}
