...
{
public:
	const int EXPECTED_SCHEMA_VERSION = 3;
	...
	bool addUrl(const QString string_id, const QString filename, const QString path, const QString filename_with_path, const QString file_id, const qint64 size, const bool file_exists, const QDateTime created, int user_id);
