...
public:
	...
	static QCCollection variantList( VcfFileHandler variants, bool filter);
	...
	static AncestryEstimates ancestry(QString build, const  VcfFileHandler& variants, int min_snp=100, double min_pop_dist = 0.15);
