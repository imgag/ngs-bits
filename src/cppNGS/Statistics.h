...
public:
	...
	///Calculates somatic TMB metric from somatic vcf
	static QCValue somatic_tmb(QString &somatic_vcf, const QString &exons, const QString &target, const QString &tsg, const QString &blacklist);
