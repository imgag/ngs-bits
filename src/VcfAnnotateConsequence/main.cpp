...
public:
	...
	virtual void setup()
	{
		...
		addFlag("all", "If set, all transcripts are used for annotation. The default is to skip transcripts not labeled with 'gencode_basic' and not labeled with 'RefSeq'/'BestRefSeq' origin for Refseq.");
