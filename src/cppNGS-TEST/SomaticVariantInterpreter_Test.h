...
private slots:
	...
	void somaticVariantInterpreterInput()
	{
		SomaticVariantInterpreterInput input_data;
		IS_TRUE(input_data.isValid());

		input_data.known_oncogenic_aa = SomaticVariantInterpreterInput::TRUE;
		input_data.located_in_canerhotspot = SomaticVariantInterpreterInput::FALSE;
		IS_FALSE(input_data.isValid());

		input_data.located_in_canerhotspot = SomaticVariantInterpreterInput::NOT_APPLICABLE;
		IS_TRUE(input_data.isValid());
		input_data.other_aa_known_oncogenic = SomaticVariantInterpreterInput::FALSE;
		IS_FALSE(input_data.isValid());

		//evidence counts
		input_data = SomaticVariantInterpreterInput();
		I_EQUAL(input_data.strongEvidenceCount(), 0);
		input_data.known_oncogenic_aa = SomaticVariantInterpreterInput::TRUE;
		input_data.strong_cancerhotspot = SomaticVariantInterpreterInput::TRUE;
		I_EQUAL(input_data.strongEvidenceCount(), 2);

		I_EQUAL(input_data.moderateEvidenceCount(), 0);
		input_data.absent_from_controls = SomaticVariantInterpreterInput::TRUE;
		input_data.protein_length_change = SomaticVariantInterpreterInput::TRUE;
		input_data.weak_cancerhotspot = SomaticVariantInterpreterInput::TRUE;
		I_EQUAL(input_data.moderateEvidenceCount(), 3);

		I_EQUAL(input_data.supportingEvidenceCount(), 0);
		input_data.computational_evidence = SomaticVariantInterpreterInput::TRUE;
	...
	void viccRulesOncogenic()
	{
		...
		input_data.null_mutation_in_tsg = SomaticVariantInterpreterInput::TRUE;
		I_EQUAL(SomaticVariantInterpreter::viccScore(input_data), SomaticVariantInterpreter::result::UNCERTAIN_SIGNIFICANCE);
		input_data.oncogenic_functional_studies = SomaticVariantInterpreterInput::TRUE;
		...
		input_data = SomaticVariantInterpreterInput();
		input_data.null_mutation_in_tsg = SomaticVariantInterpreterInput::TRUE;
		input_data.located_in_canerhotspot = SomaticVariantInterpreterInput::TRUE;
		input_data.absent_from_controls = SomaticVariantInterpreterInput::TRUE;
		I_EQUAL(SomaticVariantInterpreter::viccScore(input_data), SomaticVariantInterpreter::result::ONCOGENIC);
		...
		input_data.null_mutation_in_tsg = SomaticVariantInterpreterInput::TRUE;
		input_data.protein_length_change = SomaticVariantInterpreterInput::TRUE;
		input_data.very_weak_cancerhotspot = SomaticVariantInterpreterInput::TRUE;
		I_EQUAL(SomaticVariantInterpreter::viccScore(input_data), SomaticVariantInterpreter::result::ONCOGENIC);
		...
		input_data.null_mutation_in_tsg = SomaticVariantInterpreterInput::TRUE;
		input_data.computational_evidence = SomaticVariantInterpreterInput::TRUE;
		input_data.mutation_in_gene_with_etiology = SomaticVariantInterpreterInput::TRUE;
		I_EQUAL(SomaticVariantInterpreter::viccScore(input_data), SomaticVariantInterpreter::result::ONCOGENIC);
		...
		input_data.oncogenic_functional_studies = SomaticVariantInterpreterInput::TRUE;
		input_data.absent_from_controls = SomaticVariantInterpreterInput::TRUE;
		input_data.other_aa_known_oncogenic = SomaticVariantInterpreterInput::TRUE;
		input_data.very_weak_cancerhotspot = SomaticVariantInterpreterInput::TRUE;
		input_data.mutation_in_gene_with_etiology = SomaticVariantInterpreterInput::TRUE;
		I_EQUAL(SomaticVariantInterpreter::viccScore(input_data), SomaticVariantInterpreter::result::ONCOGENIC);
	...
	void viccRulesBenign()
	{
		...
		input_data.very_high_maf = SomaticVariantInterpreterInput::TRUE;
		I_EQUAL(SomaticVariantInterpreter::viccScore(input_data), SomaticVariantInterpreter::result::BENIGN);

		//2x strong evidence
		input_data = SomaticVariantInterpreterInput();
		input_data.benign_functional_studies = SomaticVariantInterpreterInput::TRUE;
		input_data.high_maf = SomaticVariantInterpreterInput::TRUE;
		I_EQUAL(SomaticVariantInterpreter::viccScore(input_data), SomaticVariantInterpreter::result::BENIGN);
	}
	...
	void viccRulesLikelyBenign()
	{
		...
		input_data.high_maf = SomaticVariantInterpreterInput::TRUE;
		input_data.synonymous = SomaticVariantInterpreterInput::TRUE;
		input_data.benign_computational_evidence = SomaticVariantInterpreterInput::TRUE;
