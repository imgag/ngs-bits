...
TEST_CLASS(VcfLine_Test)
{
    ...
    TEST_METHOD(constructLineWithoutFile)
	{
    ...
    TEST_METHOD(infoLinefromHeader)
	{
        VcfHeader header;
    ...
    TEST_METHOD(formatLineFromHeader)
	{
        VcfHeader header;
    ...
    TEST_METHOD(filterLineFromHeader)
    {
        VcfHeader header;
    ...
    TEST_METHOD(formatEntryForSampleId)
    {
    ...
    TEST_METHOD(overlapsWithComplete)
    {
        VcfLine variant;
    ...
    TEST_METHOD(overlapsWithBedLine)
    {
        VcfLine variant;
        variant.setChromosome("chr1");
        variant.setPos(5);
