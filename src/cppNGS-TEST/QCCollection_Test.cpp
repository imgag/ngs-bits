...
private:
	...
	TEST_METHOD(QCValue_string_constructor)
	{
	...
	TEST_METHOD(QCValue_double_constructor)
	{
	...
	TEST_METHOD(QCValue_long_constructor)
	{
	...
	TEST_METHOD(QCValue_long_constructor_from_int)
	{
