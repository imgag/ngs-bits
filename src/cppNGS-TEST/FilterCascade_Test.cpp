...
private:
	...
	TEST_METHOD(FilterAlleleFrequency_apply)
	{
		VariantList vl;
	...
	TEST_METHOD(FilterAlleleFrequency_apply_without_1000g)
	{
		VariantList vl;
	...
	TEST_METHOD(FilterSubpopulationAlleleFrequency_apply)
	{
		VariantList vl;
		vl.load(TESTDATA("data_in/VariantFilter_in.GSvar"));
	...
	TEST_METHOD(FilterRegions_apply_specialCaseSingleRegion)
	{
		VariantList vl;
		vl.load(TESTDATA("data_in/VariantFilter_in.GSvar"));
	...
	TEST_METHOD(FilterRegions_apply)
	{
		VariantList vl;
		vl.load(TESTDATA("data_in/VariantFilter_in.GSvar"));
	...
	TEST_METHOD(FilterFilterColumnEmpty_apply)
	{
		VariantList vl;
		vl.load(TESTDATA("data_in/VariantFilter_in.GSvar"));
	...
	TEST_METHOD(FilterVariantIsSNP_apply)
	{
		VariantList vl;
		vl.load(TESTDATA("data_in/VariantFilter_in.GSvar"));
	...
	TEST_METHOD(FilterVariantImpact_apply)
	{
		VariantList vl;
		vl.load(TESTDATA("data_in/VariantFilter_in.GSvar"));
	...
	TEST_METHOD(FilterVariantCountNGSD_apply)
	{
		VariantList vl;
		vl.load(TESTDATA("data_in/VariantFilter_in.GSvar"));
	...
	TEST_METHOD(FilterClassificationNGSD_apply)
	{
		VariantList vl;
		vl.load(TESTDATA("data_in/VariantFilter_in.GSvar"));
	...
	TEST_METHOD(FilterFilterColumn_apply)
	{
		VariantList vl;
		vl.load(TESTDATA("data_in/VariantFilter_in.GSvar"));
	...
	TEST_METHOD(FilterGeneConstraint_apply)
	{
		VariantList vl;
		vl.load(TESTDATA("data_in/VariantFilter_in.GSvar"));
	...
	TEST_METHOD(FilterGeneInheritance_apply)
	{
		VariantList vl;
		vl.load(TESTDATA("data_in/VariantFilter_in.GSvar"));
	...
	TEST_METHOD(FilterColumnMatchRegexp_apply)
	{
		VariantList vl;
		vl.load(TESTDATA("data_in/VariantFilter_in.GSvar"));
	...
	TEST_METHOD(FilterGenotypeControl_apply_multiSample)
	{
		VariantList vl;
	...
	TEST_METHOD(FilterGenotypeAffected_apply)
	{
		VariantList vl;
		vl.load(TESTDATA("data_in/VariantFilter_in.GSvar"));
	...
	TEST_METHOD(FilterGenotypeAffected_apply_multiSample)
	{
		VariantList vl;
		vl.load(TESTDATA("data_in/VariantFilter_in_multi.GSvar"));
	...
	TEST_METHOD(FilterGenotypeAffected_apply_comphet)
	{
		VariantList vl;
		vl.load(TESTDATA("data_in/VariantFilter_in.GSvar"));
	...
	TEST_METHOD(FilterGenotypeAffected_apply_comphet_hom)
	{
		VariantList vl;
		vl.load(TESTDATA("data_in/VariantFilter_in.GSvar"));
	...
	TEST_METHOD(FilterGenotypeAffected_apply_multiSample_comphet)
	{
		VariantList vl;
		vl.load(TESTDATA("data_in/VariantFilter_in_multi.GSvar"));
	...
	TEST_METHOD(FilterGenotypeAffected_apply_multiSample_comphet_hom)
	{
		VariantList vl;
		vl.load(TESTDATA("data_in/VariantFilter_in_multi.GSvar"));
	...
	TEST_METHOD(FilterGenotypeAffected_apply_comphet_phased)
	{
		VariantList vl;
	...
	TEST_METHOD(FilterAnnotationPathogenic_apply)
	{
		VariantList vl;
		vl.load(TESTDATA("data_in/VariantFilter_in.GSvar"));
	...
	TEST_METHOD(FilterPredictionPathogenic_apply)
	{
		VariantList vl;
		vl.load(TESTDATA("data_in/VariantFilter_in.GSvar"));
	...
	TEST_METHOD(FilterAnnotationText_apply)
	{
		VariantList vl;
		vl.load(TESTDATA("data_in/VariantFilter_in.GSvar"));
	...
	TEST_METHOD(FilterVariantType_apply)
	{
		VariantList vl;
		vl.load(TESTDATA("data_in/VariantFilter_in.GSvar"));
	...
	TEST_METHOD(FilterVariantQC_apply)
	{
		VariantList vl;
		vl.load(TESTDATA("data_in/VariantFilter_in.GSvar"));
	...
	TEST_METHOD(FilterConservedness_apply)
	{
		VariantList vl;
		vl.load(TESTDATA("data_in/VariantFilter_in.GSvar"));
	...
	TEST_METHOD(FilterRegulatory_apply)
	{
		VariantList vl;
		vl.load(TESTDATA("data_in/VariantFilter_in.GSvar"));
	...
	TEST_METHOD(FilterSplice_apply)
	{
		VariantList vl;
	...
	TEST_METHOD(FilterVariantRNAAseAlleleFrequency_apply)
	{
		VariantList vl;
		vl.load(TESTDATA("data_in/VariantFilter_in.GSvar"));
	...
	TEST_METHOD(FilterVariantRNAAseAlt_apply)
	{
		VariantList vl;
		vl.load(TESTDATA("data_in/VariantFilter_in.GSvar"));
	...
	TEST_METHOD(FilterVariantRNAAseDepth_apply)
	{
		VariantList vl;
		vl.load(TESTDATA("data_in/VariantFilter_in.GSvar"));
	...
	TEST_METHOD(FilterVariantRNAAsePval_apply)
	{
		VariantList vl;
		vl.load(TESTDATA("data_in/VariantFilter_in.GSvar"));
	...
	TEST_METHOD(FilterVariantRNAAberrantSplicing_apply)
	{
		VariantList vl;
		vl.load(TESTDATA("data_in/VariantFilter_in.GSvar"));
	...
	TEST_METHOD(FilterVariantRNAExpressionFC_apply)
	{
		VariantList vl;
		vl.load(TESTDATA("data_in/VariantFilter_in.GSvar"));
	...
	TEST_METHOD(FilterVariantRNAExpressionZScore_apply)
	{
		VariantList vl;
		vl.load(TESTDATA("data_in/VariantFilter_in.GSvar"));
	...
	TEST_METHOD(FilterVariantRNAGeneExpression_apply)
	{
		VariantList vl;
		vl.load(TESTDATA("data_in/VariantFilter_in.GSvar"));
	...
	TEST_METHOD(FilterVariantLrSrOverlap_apply)
	{
		VariantList vl;
		vl.load(TESTDATA("data_in/VariantFilter_in.GSvar"));
	...
	TEST_METHOD(FilterSomaticAlleleFrequency_apply_tumor_only)
	{
		VariantList vl;
	...
	TEST_METHOD(FilterSomaticAlleleFrequency_apply_tumor_normal)
	{
		VariantList vl;
	...
	TEST_METHOD(FilterCnvSize_apply)
	{
		CnvList cnvs;
	...
	TEST_METHOD(FilterCnvCopyNumber_apply_ClinCNV_germline)
	{
		CnvList cnvs;
		cnvs.load(TESTDATA("data_in/CnvList_ClinCNV_germline.tsv"));
	...
	TEST_METHOD(FilterCnvAlleleFrequency_apply_ClinCNV_germline)
	{
		CnvList cnvs;
		cnvs.load(TESTDATA("data_in/CnvList_ClinCNV_germline.tsv"));
	...
	TEST_METHOD(FilterCnvLoglikelihood_apply)
	{
		CnvList cnvs;
		cnvs.load(TESTDATA("data_in/CnvList_ClinCNV_germline.tsv"));
	...
	TEST_METHOD(FilterCnvLoglikelihood_apply_scaled)
	{
		CnvList cnvs;
		cnvs.load(TESTDATA("data_in/CnvList_ClinCNV_germline.tsv"));
	...
	TEST_METHOD(FilterCnvLoglikelihood_apply_multi)
	{
		CnvList cnvs;
	...
	TEST_METHOD(FilterCnvLoglikelihood_apply_trio_with_regions)
	{
		CnvList cnvs;
	...
	TEST_METHOD(FilterCnvQvalue_apply)
	{
		CnvList cnvs;
		cnvs.load(TESTDATA("data_in/CnvList_ClinCNV_germline.tsv"));
	...
	TEST_METHOD(FilterCnvQvalue_apply_multi)
	{
		CnvList cnvs;
		cnvs.load(TESTDATA("data_in/CnvList_ClinCNV_germline_multi.tsv"));
	...
	TEST_METHOD(FilterCnvCompHet_apply_cnv_snvindel)
	{
		CnvList cnvs;
		cnvs.load(TESTDATA("data_in/CnvList_ClinCNV_germline.tsv"));
	...
	TEST_METHOD(FilterCnvOMIM_apply)
	{
		CnvList cnvs;
		cnvs.load(TESTDATA("data_in/CnvList_ClinCNV_germline.tsv"));
	...
	TEST_METHOD(FilterCnvCnpOverlap_apply)
	{
		CnvList cnvs;
		cnvs.load(TESTDATA("data_in/CnvList_ClinCNV_germline.tsv"));
	...
	TEST_METHOD(default_filters_ClinCNV_germline_multi)
	{
		CnvList cnvs;
		cnvs.load(TESTDATA("data_in/CnvList_ClinCNV_germline_trio_with_regions.tsv"));
	...
	TEST_METHOD(default_filters_ClinCNV_somatic)
	{
		CnvList cnvs;
		cnvs.load(TESTDATA("data_in/CnvList_ClinCNV_somatic.tsv"));
	...
	TEST_METHOD(FilterSvType_apply)
	{
		BedpeFile svs;
	...
	TEST_METHOD(FilterSvRemoveChromosomeType_apply)
	{
		BedpeFile svs;
		svs.load(TESTDATA("data_in/SV_Manta_germline.bedpe"));
	...
	TEST_METHOD(FilterSvGenotypeAffected_apply)
	{
		BedpeFile svs;
		svs.load(TESTDATA("data_in/SV_Manta_germline.bedpe"));
	...
	TEST_METHOD(FilterSvGenotypeAffected_apply_multi)
	{
		BedpeFile svs;
	...
	TEST_METHOD(FilterSvGenotypeControl_apply_multi)
	{
		BedpeFile svs;
		svs.load(TESTDATA("data_in/SV_Manta_germline_multi.bedpe"));
	...
	TEST_METHOD(FilterSvQuality_apply)
	{
		BedpeFile svs;
		svs.load(TESTDATA("data_in/SV_Manta_germline.bedpe"));
	...
	TEST_METHOD(FilterSvFilterColumn_remove)
	{
		BedpeFile svs;
		svs.load(TESTDATA("data_in/SV_Manta_germline.bedpe"));
	...
	TEST_METHOD(FilterSvFilterColumn_filter)
	{
		BedpeFile svs;
		svs.load(TESTDATA("data_in/SV_Manta_germline.bedpe"));
    ...
    TEST_METHOD(FilterSvFilterColumn_filterMulti)
	{
		BedpeFile svs;
		svs.load(TESTDATA("data_in/SV_Manta_germline.bedpe"));
	...
	TEST_METHOD(FilterSvFilterColumn_keep)
	{
		BedpeFile svs;
		svs.load(TESTDATA("data_in/SV_Manta_germline.bedpe"));
	...
	TEST_METHOD(FilterSvPairedReadAF_apply)
	{
		BedpeFile svs;
		svs.load(TESTDATA("data_in/SV_Manta_germline.bedpe"));
	...
	TEST_METHOD(FilterSvPairedReadAF_apply_multi)
	{
		BedpeFile svs;
		svs.load(TESTDATA("data_in/SV_Manta_germline_multi.bedpe"));
    ...
    TEST_METHOD(FilterSvPairedReadAF_apply_multi2)
    {
        BedpeFile svs;
        svs.load(TESTDATA("data_in/SV_Manta_germline_multi.bedpe"));
	...
	TEST_METHOD(FilterSvSplitReadAF_apply)
	{
		BedpeFile svs;
		svs.load(TESTDATA("data_in/SV_Manta_germline.bedpe"));
	...
	TEST_METHOD(FilterSvSplitReadAF_apply_multi)
	{
		BedpeFile svs;
		svs.load(TESTDATA("data_in/SV_Manta_germline_multi.bedpe"));
    ...
    TEST_METHOD(FilterSvSplitReadAF_apply_multi2)
    {
        BedpeFile svs;
        svs.load(TESTDATA("data_in/SV_Manta_germline_multi.bedpe"));
	...
	TEST_METHOD(FilterSvPeReadDepth_apply)
	{
		BedpeFile svs;
		svs.load(TESTDATA("data_in/SV_Manta_germline.bedpe"));
	...
	TEST_METHOD(FilterSvPeReadDepth_apply_multi)
	{
		BedpeFile svs;
		svs.load(TESTDATA("data_in/SV_Manta_germline_multi.bedpe"));
    ...
    TEST_METHOD(FilterSvPeReadDepth_apply_multi2)
    {
        BedpeFile svs;
        svs.load(TESTDATA("data_in/SV_Manta_germline_multi.bedpe"));
	...
	TEST_METHOD(FilterSvSomaticscore_apply)
	{
		BedpeFile svs;
	...
	TEST_METHOD(FilterSvGeneConstraint_apply)
	{
		BedpeFile svs;
		svs.load(TESTDATA("data_in/SV_Manta_germline.bedpe"));
	...
	TEST_METHOD(FilterSvSize_apply)
	{
		BedpeFile svs;
		svs.load(TESTDATA("data_in/SV_Manta_germline.bedpe"));
	...
	TEST_METHOD(FilterSvOMIM_filter_apply)
	{
		BedpeFile svs;
		svs.load(TESTDATA("data_in/SV_Manta_germline.bedpe"));
	...
	TEST_METHOD(FilterSvOMIM_remove_apply)
	{
		BedpeFile svs;
		svs.load(TESTDATA("data_in/SV_Manta_germline.bedpe"));
	...
	TEST_METHOD(FilterSvCountNGSD_apply_default)
	{
		BedpeFile svs;
		svs.load(TESTDATA("data_in/SV_Manta_germline.bedpe"));
	...
	TEST_METHOD(FilterSvCountNGSD_apply_ignore_genotype)
	{
		BedpeFile svs;
		svs.load(TESTDATA("data_in/SV_Manta_germline.bedpe"));
	...
	TEST_METHOD(FilterSvCountNGSD_apply_custom)
	{
	...
	TEST_METHOD(FilterSvAfNGSD_apply_default)
	{
	...
	TEST_METHOD(FilterSvAfNGSD_apply_custom)
	{
	...
	TEST_METHOD(FilterSvBreakpointDensityNGSD_default)
	{
	...
	TEST_METHOD(FilterSvBreakpointDensityNGSD_custom)
	{
	...
	TEST_METHOD(FilterSvBreakpointDensityNGSD_system_specific)
	{
	...
	TEST_METHOD(FilterSvTrio_apply)
	{
		BedpeFile svs;
	...
	TEST_METHOD(FilterSvLrAF_apply)
	{
	...
	TEST_METHOD(FilterSvLrSupportReads_apply)
	{
	...
	TEST_METHOD(default_filters_SV_germline)
	{
		BedpeFile svs;
		svs.load(TESTDATA("data_in/SV_Manta_germline.bedpe"));
	...
	TEST_METHOD(default_filters_SV_somatic)
	{
		BedpeFile svs;
		svs.load(TESTDATA("data_in/SV_Manta_somatic.bedpe"));
	...
	TEST_METHOD(load_bug_empty_enum)
	{
		VariantList vl;
		vl.load(TESTDATA("data_in/VariantFilter_in.GSvar"));
