...
TEST_CLASS(Statistics_Test)
{
	...
	TEST_METHOD(somatic_mutation_burden)
	{
	...
	TEST_METHOD(variantList_panel_filter)
	{
		VcfFile vl;
	...
	TEST_METHOD(variantList_panel_nofilter)
	{
		VcfFile vl;
		vl.load(TESTDATA("data_in/panel_vep.vcf"));
	...
	TEST_METHOD(mapping_panel)
	{
		...
		S_EQUAL(stats[7].name(), QString("target region read depth (no ol)"));
		F_EQUAL2(stats[7].asDouble(), 77.1401, 0.0001);
		S_EQUAL(stats[8].name(), QString("duplicate read percentage"));
		S_EQUAL(stats[8].toString(), QString("n/a (no duplicates marked or duplicates removed during data analysis)"));
		S_EQUAL(stats[9].name(), QString("bases usable (MB)"));
		S_EQUAL(stats[9].toString(), QString("34.06"));
		S_EQUAL(stats[10].name(), QString("target region read depth"));
		S_EQUAL(stats[10].toString(), QString("125.45"));
		S_EQUAL(stats[11].name(), QString("target region 10x percentage"));
		S_EQUAL(stats[11].toString(), QString("97.13"));
		S_EQUAL(stats[12].name(), QString("target region 20x percentage"));
		S_EQUAL(stats[12].toString(), QString("94.06"));
		S_EQUAL(stats[13].name(), QString("target region 30x percentage"));
		S_EQUAL(stats[13].toString(), QString("90.23"));
		S_EQUAL(stats[14].name(), QString("target region 50x percentage"));
		S_EQUAL(stats[14].toString(), QString("80.75"));
		S_EQUAL(stats[15].name(), QString("target region 60x percentage"));
		S_EQUAL(stats[15].toString(), QString("75.73"));
		S_EQUAL(stats[16].name(), QString("target region 100x percentage"));
		S_EQUAL(stats[16].toString(), QString("55.39"));
		S_EQUAL(stats[17].name(), QString("target region 200x percentage"));
		S_EQUAL(stats[17].toString(), QString("18.14"));
		S_EQUAL(stats[18].name(), QString("target region 500x percentage"));
		S_EQUAL(stats[18].toString(), QString("0.06"));
		S_EQUAL(stats[19].name(), QString("target region half depth percentage"));
		S_EQUAL(stats[19].toString(), QString("74.35"));
		S_EQUAL(stats[20].name(), QString("AT dropout"));
		S_EQUAL(stats[20].toString(), QString("8.42"));
		S_EQUAL(stats[21].name(), QString("GC dropout"));
		S_EQUAL(stats[21].toString(), QString("1.18"));
		S_EQUAL(stats[22].name(), QString("depth distribution plot"));
		IS_TRUE(stats[22].type()==QCValueType::IMAGE);
		S_EQUAL(stats[23].name(), QString("insert size distribution plot"));
	...
	TEST_METHOD(mapping_close_exons)
	{
		...
		S_EQUAL(stats[7].name(), QString("target region read depth (no ol)"));
		F_EQUAL2(stats[7].asDouble(), 200.448, 0.0001);
		S_EQUAL(stats[8].name(), QString("duplicate read percentage"));
		S_EQUAL(stats[8].toString(), QString("n/a (no duplicates marked or duplicates removed during data analysis)"));
		S_EQUAL(stats[9].name(), QString("bases usable (MB)"));
		S_EQUAL(stats[9].toString(), QString("0.06"));
		S_EQUAL(stats[10].name(), QString("target region read depth"));
		S_EQUAL(stats[10].toString(), QString("388.79"));
		S_EQUAL(stats[11].name(), QString("target region 10x percentage"));
		...
		S_EQUAL(stats[16].name(), QString("target region 100x percentage"));
		S_EQUAL(stats[16].toString(), QString("93.51"));
		S_EQUAL(stats[17].name(), QString("target region 200x percentage"));
		S_EQUAL(stats[17].toString(), QString("79.87"));
		S_EQUAL(stats[18].name(), QString("target region 500x percentage"));
		S_EQUAL(stats[18].toString(), QString("30.52"));
		S_EQUAL(stats[19].name(), QString("target region half depth percentage"));
		S_EQUAL(stats[19].toString(), QString("79.87"));
		S_EQUAL(stats[20].name(), QString("AT dropout"));
		S_EQUAL(stats[20].toString(), QString("0.00"));
		S_EQUAL(stats[21].name(), QString("GC dropout"));
		S_EQUAL(stats[21].toString(), QString("14.22"));
		S_EQUAL(stats[22].name(), QString("depth distribution plot"));
		IS_TRUE(stats[22].type()==QCValueType::IMAGE);
		S_EQUAL(stats[23].name(), QString("insert size distribution plot"));
		IS_TRUE(stats[23].type()==QCValueType::IMAGE);
	...
	TEST_METHOD(mapping)
	{
		...
		S_EQUAL(stats[6].name(), QString("target region read depth (no ol)"));
		F_EQUAL2(stats[6].asDouble(), 0.0000300418, 0.0000001);
		S_EQUAL(stats[7].name(), QString("duplicate read percentage"));
		S_EQUAL(stats[7].toString(), QString("n/a (duplicates not marked or removed during data analysis)"));
		S_EQUAL(stats[8].name(), QString("bases usable (MB)"));
		S_EQUAL(stats[8].toString(), QString("0.17"));
		S_EQUAL(stats[9].name(), QString("target region read depth"));
		F_EQUAL2(stats[9].asDouble(), 0.0000578, 0.0000001);
		S_EQUAL(stats[10].name(), QString("insert size distribution plot"));
		IS_TRUE(stats[10].type()==QCValueType::IMAGE);
		I_EQUAL(stats.count(), 11);
	}
	...
	TEST_METHOD(mapping_wgs)
	{
		...
		S_EQUAL(stats[6].name(), QString("target region read depth (no ol)"));
		F_EQUAL2(stats[6].asDouble(), 0.000118, 0.000001);
		S_EQUAL(stats[7].name(), QString("duplicate read percentage"));
		S_EQUAL(stats[7].toString(), QString("0.77"));
		S_EQUAL(stats[8].name(), QString("bases usable (MB)"));
		S_EQUAL(stats[8].toString(), QString("0.33"));
		S_EQUAL(stats[9].name(), QString("target region read depth"));
		F_EQUAL2(stats[9].asDouble(), 0.0001128, 0.0000001);
		S_EQUAL(stats[10].name(), QString("target region 10x percentage"));
		S_EQUAL(stats[10].toString(), QString("22.10"));
		S_EQUAL(stats[11].name(), QString("target region 20x percentage"));
		S_EQUAL(stats[11].toString(), QString("14.94"));
		S_EQUAL(stats[12].name(), QString("target region 30x percentage"));
		S_EQUAL(stats[12].toString(), QString("10.80"));
		S_EQUAL(stats[13].name(), QString("target region 50x percentage"));
		S_EQUAL(stats[13].toString(), QString("6.41"));
		S_EQUAL(stats[14].name(), QString("target region 60x percentage"));
		S_EQUAL(stats[14].toString(), QString("4.77"));
		S_EQUAL(stats[15].name(), QString("target region 100x percentage"));
		S_EQUAL(stats[15].toString(), QString("1.24"));
		...
		S_EQUAL(stats[17].toString(), QString("0.00"));
		S_EQUAL(stats[18].name(), QString("target region half depth percentage"));
		S_EQUAL(stats[18].toString(), QString("26.99"));
		S_EQUAL(stats[19].name(), QString("AT dropout"));
		S_EQUAL(stats[19].toString(), QString("5.47"));
		S_EQUAL(stats[20].name(), QString("GC dropout"));
		S_EQUAL(stats[20].toString(), QString("0.30"));
	...
	TEST_METHOD(mapping_cfdna)
	{
		...
		S_EQUAL(stats[7].name(), QString("target region read depth (no ol)"));
		F_EQUAL2(stats[7].asDouble(), 4936.42, 0.01);
		S_EQUAL(stats[8].name(), QString("duplicate read percentage"));
		S_EQUAL(stats[8].toString(), QString("n/a (no duplicates marked or duplicates removed during data analysis)"));
		S_EQUAL(stats[9].name(), QString("bases usable (MB)"));
		S_EQUAL(stats[9].toString(), QString("1.56"));
		S_EQUAL(stats[10].name(), QString("target region read depth"));
		S_EQUAL(stats[10].toString(), QString("6505.90"));
		S_EQUAL(stats[11].name(), QString("target region read depth 2-fold duplication"));
		S_EQUAL(stats[11].toString(), QString("4668.92"));
		S_EQUAL(stats[12].name(), QString("target region read depth 3-fold duplication"));
		S_EQUAL(stats[12].toString(), QString("4568.45"));
		S_EQUAL(stats[13].name(), QString("target region read depth 4-fold duplication"));
		S_EQUAL(stats[13].toString(), QString("4531.60"));
		S_EQUAL(stats[14].name(), QString("raw target region read depth"));
		S_EQUAL(stats[14].toString(), QString("242405.61"));
		S_EQUAL(stats[15].name(), QString("target region 10x percentage"));
		S_EQUAL(stats[15].toString(), QString("100.00"));
		S_EQUAL(stats[16].name(), QString("target region 20x percentage"));
		S_EQUAL(stats[16].toString(), QString("100.00"));
		S_EQUAL(stats[17].name(), QString("target region 30x percentage"));
		S_EQUAL(stats[17].toString(), QString("100.00"));
		S_EQUAL(stats[18].name(), QString("target region 50x percentage"));
		S_EQUAL(stats[18].toString(), QString("100.00"));
		S_EQUAL(stats[19].name(), QString("target region 60x percentage"));
		S_EQUAL(stats[19].toString(), QString("100.00"));
		S_EQUAL(stats[20].name(), QString("target region 100x percentage"));
		S_EQUAL(stats[20].toString(), QString("100.00"));
		S_EQUAL(stats[21].name(), QString("target region 200x percentage"));
		S_EQUAL(stats[21].toString(), QString("100.00"));
		S_EQUAL(stats[22].name(), QString("target region 500x percentage"));
		S_EQUAL(stats[22].toString(), QString("100.00"));
		S_EQUAL(stats[23].name(), QString("target region 1000x percentage"));
		S_EQUAL(stats[23].toString(), QString("100.00"));
		S_EQUAL(stats[24].name(), QString("target region 2500x percentage"));
		S_EQUAL(stats[24].toString(), QString("100.00"));
		S_EQUAL(stats[25].name(), QString("target region 5000x percentage"));
		S_EQUAL(stats[25].toString(), QString("93.75"));
		S_EQUAL(stats[26].name(), QString("target region 7500x percentage"));
		S_EQUAL(stats[26].toString(), QString("46.25"));
		S_EQUAL(stats[27].name(), QString("target region 10000x percentage"));
		S_EQUAL(stats[27].toString(), QString("0.00"));
		S_EQUAL(stats[28].name(), QString("target region 15000x percentage"));
		S_EQUAL(stats[28].toString(), QString("0.00"));
		S_EQUAL(stats[29].name(), QString("target region half depth percentage"));
		S_EQUAL(stats[29].toString(), QString("100.00"));
		S_EQUAL(stats[30].name(), QString("AT dropout"));
		S_EQUAL(stats[30].toString(), QString("10.58"));
		S_EQUAL(stats[31].name(), QString("GC dropout"));
		S_EQUAL(stats[31].toString(), QString("0.00"));
		S_EQUAL(stats[32].name(), QString("depth distribution plot"));
		IS_TRUE(stats[32].type()==QCValueType::IMAGE);
		S_EQUAL(stats[33].name(), QString("insert size distribution plot"));
		IS_TRUE(stats[33].type()==QCValueType::IMAGE);
		S_EQUAL(stats[34].name(), QString("fragment duplication distribution plot"));
		IS_TRUE(stats[34].type()==QCValueType::IMAGE);
		S_EQUAL(stats[35].name(), QString("duplication-coverage plot"));
		IS_TRUE(stats[35].type()==QCValueType::IMAGE);
		S_EQUAL(stats[36].name(), QString("GC bias plot"));
		IS_TRUE(stats[36].type()==QCValueType::IMAGE);
	}
	...
	TEST_METHOD(lowCoverage_roi_mapq20)
	{
		BedFile bed_file;
		bed_file.load(TESTDATA("data_in/panel.bed"));
		bed_file.merge();
	...
	TEST_METHOD(lowCoverage_roi_mapq20_multiple_threads)
	{
		BedFile bed_file;
		bed_file.load(TESTDATA("data_in/panel.bed"));
		bed_file.merge();
	...
	TEST_METHOD(lowCoverage_roi_closeExons)
	{
		BedFile bed_file;
		bed_file.load(TESTDATA("data_in/close_exons.bed"));
		bed_file.merge();
	...
	TEST_METHOD(highCoverage_roi_mapq20_multiple_threads)
	{
		BedFile bed_file;
		bed_file.load(TESTDATA("data_in/panel.bed"));
		bed_file.merge();
	...
	TEST_METHOD(avgCoverage_overlapping_regions)
	{
		BedFile bed_file;
	...
	TEST_METHOD(avgCoverage_1decimal)
	{
		BedFile bed_file;
		bed_file.load(TESTDATA("data_in/close_exons.bed"));
		bed_file.merge();
