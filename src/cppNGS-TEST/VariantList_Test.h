...
private slots:
	...
	void loadFromVCF()
	{
		...
		QCOMPARE(vl[0].ref(), QString("G"));
		QCOMPARE(vl[0].obs(), QString("GA"));
		...
		QCOMPARE(vl[12].ref(), QString("G"));
		QCOMPARE(vl[12].obs(), QString("A"));
	...
	void loadFromTSV()
	{
		...
		QCOMPARE(vl[0].ref(), QString("C"));
		QCOMPARE(vl[0].obs(), QString("T"));
		...
		QCOMPARE(vl[74].ref(), QString("G"));
		QCOMPARE(vl[74].obs(), QString("C"));
