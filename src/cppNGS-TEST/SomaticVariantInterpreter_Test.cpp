...
private:
	...
	TEST_METHOD(SomaticViccDataTest)
	{
	...
	TEST_METHOD(viccRulesOncogenic)
	{
		SomaticViccData input_data;
	...
	TEST_METHOD(viccRulesLikelyOncogenic)
	{
		SomaticViccData input_data;
	...
	TEST_METHOD(viccRulesLikelyBenign)
	{
		SomaticViccData input_data;
	...
	TEST_METHOD(viccRulesUncertainSignificance)
	{
		SomaticViccData input_data;
	...
	TEST_METHOD(predictViccParameters)
	{
		VariantList vl;
