...
void SvWidget::initGUI()
{
    ...
    if((report_config_ != NULL) && !is_somatic_) report_variant_indices = NGSHelper::listToSet(report_config_->variantIndices(VariantType::SVS, false));
    if((som_report_config_ != NULL) && is_somatic_) report_variant_indices = NGSHelper::listToSet(som_report_config_->variantIndices(VariantType::SVS, false));
