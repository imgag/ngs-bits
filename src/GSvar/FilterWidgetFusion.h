#ifndef FilterWidgetFusion_H
#define FilterWidgetFusion_H

#include <QWidget>
#include "ui_FilterWidgetFusion.h"
#include "BedFile.h"
#include "GeneSet.h"
#include "Phenotype.h"
...
public:
	//Default constructor
	FilterWidgetFusion(QWidget* parent = 0);
...
private:
	...
	Ui::FilterWidgetFusion ui_;
	TargetRegionInfo roi_;
	GeneSet last_genes_;
	PhenotypeList phenotypes_;
};

#endif // FilterWidgetFusion_H
