...
DBAnnotationWorker::DBAnnotationWorker(QString ps_name, VariantList& variants, BusyDialog* busy, QString roi_file, double max_af)
...
void DBAnnotationWorker::process()
{
	try
	{
		...
		ngsd_.annotate(variants_, ps_name_, roi, max_af_);
	}
	catch (Exception& e)
	{
