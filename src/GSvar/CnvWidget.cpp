...
void CnvWidget::updateGUI()
{
    ...
    if(!is_somatic_) report_variant_indices = NGSHelper::listToSet(report_config_->variantIndices(VariantType::CNVS, false));
    else report_variant_indices = NGSHelper::listToSet(somatic_report_config_->variantIndices(VariantType::CNVS, false));
