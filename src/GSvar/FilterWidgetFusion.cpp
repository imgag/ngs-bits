...
const FilterCascade& FilterWidgetFusion::filters() const
{
...
const TargetRegionInfo& FilterWidgetFusion::targetRegion() const
{
	return roi_;
}

GeneSet FilterWidgetFusion::genes() const
{
	return GeneSet::createFromText(ui_.gene->text().toUtf8(), ',');
}

QByteArray FilterWidgetFusion::text() const
{
	return ui_.text->text().trimmed().toUtf8();
}

QString FilterWidgetFusion::region() const
{
	return ui_.region->text().trimmed();
}

void FilterWidgetFusion::setRegion(QString region)
{
	ui_.region->setText(region);
	regionChanged();
}

const PhenotypeList& FilterWidgetFusion::phenotypes() const
{
	return phenotypes_;
}

void FilterWidgetFusion::setPhenotypes(const PhenotypeList& phenotypes)
{
	phenotypes_ = phenotypes;
	phenotypesChanged();
}

ReportConfigFilter FilterWidgetFusion::reportConfigurationFilter() const
{
...
void FilterWidgetFusion::roiSelectionChanged(int index)
{
...
void FilterWidgetFusion::geneChanged()
{
...
void FilterWidgetFusion::textChanged()
{
	emit filtersChanged();
}

void FilterWidgetFusion::regionChanged()
{
	emit filtersChanged();
}

void FilterWidgetFusion::phenotypesChanged()
{
	//update GUI
	QByteArrayList tmp;
...
void FilterWidgetFusion::updateFilterName()
{
