...
public:
	...
	virtual void setup()
	{
		...
		addInfile("clinvar", "ClinVar VCF file for additional disease-gene information, from 'ftp://ftp.ncbi.nlm.nih.gov/pub/clinvar/vcf_GRCh37/archive_2.0/2018/clinvar_20180805.vcf.gz'.", true);
