...
private:
	...
	TEST_METHOD(test_with_config_file)
	{
	...
	TEST_METHOD(test_with_parameters)
	{
	...
	TEST_METHOD(test_with_unordered_info_ids)
	{
	...
	TEST_METHOD(test_with_parameters_id_only)
	{
	...
	TEST_METHOD(test_with_config_file_and_existence_only)
	{
	...
	TEST_METHOD(test_with_existence_only_from_cli)
	{
