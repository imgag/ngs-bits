...
private slots:
	...
	void test_qcML_longread()
	{
		EXECUTE("VariantQC", "-longread -in " + TESTDATA("data_in/VariantQC_in2.vcf") + " -out out/VariantQC_test04_out.qcML -phasing_bed out/VariantQC_test04_out.bed");
