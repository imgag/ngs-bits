...
private slots:
	...
	{
		EXECUTE("BedHighCoverage", "-in " + TESTDATA("../cppNGS-TEST/data_in/panel.bed") + " -bam " + TESTDATA("../cppNGS-TEST/data_in/panel.bam") + " -out out/BedHighCoverage_test03_out.bed -cutoff 20 -min_mapq 20 -min_baseq 40");
	...
	{
		EXECUTE("BedHighCoverage", "-wgs -bam " + TESTDATA("../cppNGS-TEST/data_in/panel.bam") + " -out out/BedHighCoverage_test03_out.bed -cutoff 20 -min_mapq 20 -min_baseq 40");
