...
private:
	...
	TEST_METHOD(real_data_withFAI)
	{
		...
		VCF_IS_VALID_HG19("out/VcfSort_out3.vcf")
	}
	...
	TEST_METHOD(remove_unused_contigs)
	{
		...
		VCF_IS_VALID_HG19("out/VcfSort_out5.vcf")
	}
};
