...
private slots:
	...
	void test_wes()
	{
		...
		//import
		EXECUTE("NGSDAddVariantsGermline", "-test -debug -ps NA12878_38 -var " + TESTDATA("data_in/NGSDAddVariantsGermline_in2.GSvar") + " -cnv " + TESTDATA("data_in/NGSDAddVariantsGermline_in2.tsv"));
