...
private:
	...
	TEST_METHOD(test_01)
	{
		...
		COMPARE_FILES("out/BedLiftOver_out1_unmapped.bed", TESTDATA("data_out/BedLiftOver_out1_unmapped.bed"));
	}
	...
	TEST_METHOD(test_merged_output)
	{
