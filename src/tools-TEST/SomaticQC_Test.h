...
private slots:
	...
	void no_target()
	{
		EXECUTE("SomaticQC", "-tumor_bam " + TESTDATA("../cppNGS-TEST/data_in/tumor.bam") + " -normal_bam " + TESTDATA("../cppNGS-TEST/data_in/normal.bam") + " -somatic_vcf " + TESTDATA("../cppNGS-TEST/data_in/somatic.vcf") + " -links " + TESTDATA("data_in/SomaticQC_in4.qcML") + " -genome_build hg19 -out out/SomaticQC_out1.qcML");
