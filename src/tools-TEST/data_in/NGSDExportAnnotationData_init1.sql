...
--variant
INSERT INTO variant (id, chr, start, end, ref, obs, comment, gene, 1000g, gnomad) VALUES 
(1, 'chr1', 62713224, 62713224, 'C', 'G', 'from NA12880', 'KANK4', 0.0, 0.05),
(2, 'chr1', 62713246, 62713246, 'G', 'A', '', 'KANK4', 0.0, 0.04),
(3, 'chr1', 62728784, 62728784, 'A', 'G', '', 'KANK4', 0.0, 0.04),
(4, 'chr1', 62728838, 62728838, 'T', 'C', 'from DUMMY', 'KANK4', 0.0, 0.04),
(5, 'chr1', 120539331, 120539331, 'C', 'T', '', 'NOTCH2', 0.0, 0.04),
(6, 'chr1', 120611964, 120611964, 'G', 'A', '', 'NOTCH2', 0.0, 0.04),
(7, 'chr1', 120612034, 120612034, 'T', 'G', '', 'NOTCH2', 0.0, 0.04),
(8, 'chr1', 120612040, 120612040, '-', 'CCTCCTCCG', '', 'RAD50c', 0.0, 0.14),
(9, 'chr5', 131925483, 131925483, 'G', 'C', '', 'PMS2', 0.0, 0.04),
