...
INSERT INTO `diag_status`(`processed_sample_id`, `status`, `user_id`, `date`, `outcome`, `genes_causal`, `genes_incidental`, `comment`) VALUES
(3, 'done', 99, '2018-10-23 14:09:21', 'significant findings', 'BRCA1', NULL, 'comment line1\ncomment\tline2');
