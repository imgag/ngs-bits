...
private:
	TEST_METHOD(test_small_variants_tumor_normal)
	{
        ...
        //IS_TRUE(checkLogFile("out/NGSDAddVariantsSomatic_Test_line52.log", "Variants were already imported for 'DX184894_01-DX184263_01'. Use the flag '-force' to overwrite them."));
    }
