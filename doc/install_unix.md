...
For example, the installation of the dependencies using Ubuntu 20.04 looks like that:
        ...
        > sudo apt-get install git make g++ qt5-default libqt5xmlpatterns5-dev libqt5sql5-mysql libqt5sql5-odbc libqt5charts5-dev libqt5svg5python3 python3-matplotlib libqt5svg5-dev libbz2-dev liblzma-dev libcurl4 libcurl4-openssl-dev zlib1g-dev
