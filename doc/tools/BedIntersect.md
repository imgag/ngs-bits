### BedIntersect tool help
	BedIntersect (2025_12-290-g2cffd86c1)
	...
	Optional parameters:
	  ...
	  -annotation <enum> In intersect mode the annotations are removed by default. Setting this option to 'in' or 'in2' keeps the annotation of the respective file.
	                     Default value: 'none'
	                     Valid: 'intersect,in,in2,none,in,in2'
