### VcfFilter tool help
	VcfFilter (2025_12-266-g396e1fe11)
	...
	Valid operations are '>','>=','=','!=','<=','<','is','not','contains'.
	                               Default value: ''
	  -info_flags <string>         Filter by INFO flag(s) - keep matches (comma-separated list of flags)
	                               Default value: ''
	  -info_flags_exclude <string> Filter by INFO flag(s) - exclude matches (comma-separated list of flags)
	                               Default value: ''
...
### VcfFilter changelog
	...
	2026-05-07 Added option to filter by INFO flags.
